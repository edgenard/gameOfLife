...
describe('Next Generation', () => {
  ...
  it('dead cell with more than 3 stays dead', () => {
    const oldGrid = [
      [1, 0, 1],
      [0, 0, 0],
      [1, 0, 1]
  ...
  it('returns true if grid is empty', () => {
    const grid = [
      [0, 0, 0],
      [0, 0, 0],
      [0, 0, 0]
    ...
    assert.isTrue(isGridEmpty(grid))
  })

  it('returns false if grid not empty', () => {
    const grid = [
      [0, 0, 0],
      [0, 0, 0],
      [0, 0, 1]
